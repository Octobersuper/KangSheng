...
public class BackUserServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ("updfreediamond".equals(type)) {
			String establish_two = request.getParameter("one") + "-" + request.getParameter("two");
			String establish_four = request.getParameter("tree") + "-" + request.getParameter("four");
			returnMap.put("state", backUserDao.updfreediamond(establish_two, establish_four));
		}
