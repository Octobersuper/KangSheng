...
public class BackUserDao {
	...
	private Map<String, Object> getroomone(String roomnum) {
		...
		// 换三张 是 否
		pkmap.put("adjust_brand", roombean.getAdjust_brand());
		// 定缺 是否
		pkmap.put("assured_brand", roombean.getAssured_brand());
		// 字牌算飞机 是否
		pkmap.put("aircraft", roombean.getAircraft());
		// 测距功能 开关
		pkmap.put("ranging", roombean.getRanging());
		return pkmap;
	}
	...
	private String getbrand(int value) {
		String brand = "";
		if (value != -1) {
			brand = "<img src='http://210.16.188.100:8099/Guangan_Mahjong/img/" + value + ".png' width='40px' height='50px'/>";
			return brand;
		} else {
			return brand;
		}
	 ...
	 * @return
	 */
	public Object updfreediamond(String establish_two, String establish_four) {
		String sql = "UPDATE config_table SET establish_two=?,establish_four=?";
		return baseDao.executeUpdate(sql, new Object[] { establish_two, establish_four });
	}
